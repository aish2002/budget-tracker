  ...
  return (
    <>
      <CardGroup className="mt-4">
        ...
        <Card className="m-4 midcard text-center">
          <Card.Body>
            <div className="my-4">EXTRA INCOME</div>
            <h5> Rs {income} </h5>
          </Card.Body>
        </Card>
        <Card className="m-4 midcard text-center">
          <Card.Body>
            <div className="my-4">CURRENT BUDGET</div>{" "}
            <h5> Rs {budget.budget + income - expense}</h5>
          </Card.Body>
        </Card>
      </CardGroup>
      ...
      <div className="d-flex justify-content-center mt-4 ">
        ...
        >
          <Image className="savings mt-5 mr-5" src={Piggy} responsive="true" />
        </CircularProgressbarWithChildren>
      </div>
